...
public class LoansController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("eazybank-correlation-id") String correlationId, @Valid @RequestParam
                                                  @Pattern(regexp = "(^$|[0-9]{11})")
                                                  String mobileNumber){
    ...
    public ResponseEntity<LoansContactInfoDto> getContactInfo() {
        logger.debug("Invoked loan contact details");
        return ResponseEntity
                .status(HttpStatus.OK)
