...
@Tag(
        name = "CRUD REST APIs for Accounts in NaztarBank",
        description = "CRUD REST APIs in NaztarBank to create, read, update and delete account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new customer and account in NaztarBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<String> getBuildInfoFallback(Throwable throwable){
        logger.debug("Invoked getBuildInfoFallback method");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("0.9");
    }
    ...
    @Operation(
            ...
            description = "get contact details that can be reached in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
